...
function Home() {
  const data = [
    { month: "January", profit_thisyear: 1000 , profit_lastyear: 1100 },
    ...
    { month: "December", profit_thisyear: 2500 , profit_lastyear: 12000 },
  ];
      ...
      <div className="charts">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="profit_thisyear" fill="#8884d8" />
            <Bar dataKey="profit_lastyear" fill="#82ca9d" />
          </BarChart>
        </ResponsiveContainer>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line
              ...
              activeDot={{ r: 8 }}
            />
            <Line type="monotone" dataKey="profit_lastyear" stroke="#82ca9d" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </main>
