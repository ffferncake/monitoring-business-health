...
function Home() {
  ...
  const latestOrders = [
    ...
    },
    {
      ...
      date: "2024-03-12",
      items: [
        { name: "Brew Bliss", price: 25 },
        { name: "Java Junction", price: 40 },
      ],
      total: 65,
    },
    {
    ...
    },
    {
      ...
      date: "2024-03-12",
      items: [
        { name: "The Roast Retreat", price: 15 },
        { name: "Bold Brews", price: 20 },
      ],
      total: 35,
    },
    // {
